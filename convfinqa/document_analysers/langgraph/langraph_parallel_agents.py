...
class LangGraphParallelChat(LangGraphChatter):
    """
    Invokes two agents in parallel, one uses text to answer and the other uses the table and
    then their output is passed to an aggregator agent that computes final answer.
    """
